...
const ProductInfoOne = () => {
    ...
    return (
        <Section id={'products'} className="section product-section" style={{ position: 'relative' }}>
            <div className="container">
                <div className="product-content staggered">
                    <div className="product-image-container stagger-left-up">
                    ...
                    <div className="product-info-container stagger-right-down">
